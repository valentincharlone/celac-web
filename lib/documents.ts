...
export const DOCUMENTS: CelacDocument[] = [
  ...
  { title: "Declaración de Santiago", year: 2013, category: "declaraciones", size: "263 KB", format: "PDF", href: "/documentos/declaracion-de-santiago-2013.pdf" },
  ...
  // — CELAC – UE —
  { title: "Declaración de Santiago de Chile", year: 2013, category: "celacUe", size: "263 KB", format: "PDF", href: "/documentos/declaracion-de-santiago-de-chile-2013.pdf" },
