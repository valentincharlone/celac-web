    ...
    <section className="py-20 md:py-28 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
        ...
        >
          ...
          <div className="relative h-72 sm:h-88 mr-6 rounded-sm overflow-hidden shadow-xl">
            <Image
          ...
          <div className="absolute bottom-0 left-0 w-3/5 h-36 sm:h-44 rounded-sm overflow-hidden shadow-xl ring-4 ring-celac-gray">
            <Image
